...
Pid2=Pi/2.0d0
Gr=6.67384d-11 !N m^2 kg^-2  Gravitation constant
Gr=6.671981d-11 !for whatever reason.. this works with Mercury...
...
do ii=1,nbodies
   ...
   if(Per>0.0d0)then
      adrs=1000.0*sol(1)*Gr*(Psec)**2/(3.0d0*Pi)
      adrs=adrs**(1.0d0/3.0d0) !a/R*
      irad(i)=pid2-acos(b/adrs) !inclination radians  0 deg -> b=0
   else
