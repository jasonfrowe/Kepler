      program transitboot
      implicit none
      integer nmax,iargc,nunit,npt,nfit,npars,itmax,it,i,j,iboot
      parameter(nmax=600000,nfit=18,iboot=100000)
     ...
     .  dchistop,kmag,kerr,err(nfit),inclmin
C     RV Parameters
      integer nptv
...
C     Bootstrap parameters
     ...
     .  dlk,lk,lkold,likelihood,tmodel2(nmax)
      character*80 obsfile,inputsol,chseed,rvfile
      logical loop
...
c     .   write(6,500) (sol2(i),i=1,nfit),rchi !write bootstrap to STDOUT
 ...
 10   continue
      ...
      goto 999
 901  write(0,*) "Usage: transitboot <obsfile> <rvfile> <inputsol>"
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      implicit none
      integer npt,nptv,npta,seed,i,j,nfit
