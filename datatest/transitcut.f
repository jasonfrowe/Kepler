     ...
     .  flux(nmax),ferr(nmax),stdev,std,my
      character*80 filename,fitparsfile,cline
      
      
      if(iargc().lt.2) goto 901
      call getarg(1,filename)
c      call getarg(2,cline)
c      read(cline,*) sigclip
c      if(sigclip.le.0) goto 901
...
c      std=stdev(npt2,y,my)
 ...
 11   continue
      ...
      goto 999
 901  write(0,*) "Usage: sigclip <filein> <f1.dat>"
      write(0,*) "<filein> Kepler photometry"
c      write(0,*) "<sigclip> sigma value for clipping"
