...
c      call PGENV ( -0.5 , 0.5 , -0.5 , 0.5 , 1 , -2 )  
      call pgwindow(6500.0,5500.0,1.0,0.0)
      call pgslw(3)
      call pgsch(1.5)
     ...
     .  "\(0643) (g/cm\u3\d)","")
      ...
      nunit=10
      filename(1)="m10z0207.track2"
      filename(2)="m11z0207.track2"
      filename(3)="m12z0207.track2"
      filename(4)="m13z0207.track2"
      filename(5)="m14z0207.track2"
      M(1)=1.0
      M(2)=1.1
      M(3)=1.2
      M(4)=1.3
