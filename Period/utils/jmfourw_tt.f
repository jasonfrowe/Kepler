...
c      call pgsls(1)
        ...
        if(bb(4).lt.5.0)then
            call pgwindow(bb(1),bb(2),bb(3),60.0*bb(4))
        else
            call pgwindow(bb(1),bb(2),bb(3),bb(4))
        endif
        ...
        dumr=1.0e6/86400.0
        if(bb(4).lt.5.0)then
            call pgwindow(dumr*bb(1),dumr*bb(2),bb(3),60.0*bb(4))
        else
            call pgwindow(dumr*bb(1),dumr*bb(2),bb(3),bb(4))
        endif
