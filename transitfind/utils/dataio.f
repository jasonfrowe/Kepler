...
c      if((dtime(i).gt.54964.0).and.(dtime(i).lt.54965.5)) goto 9
c      if((dtime(i).gt.55000.0).and.(dtime(i).lt.55010.0)) goto 9
c      if((dtime(i).gt.55062.0).and.(dtime(i).lt.55066.0)) goto 9
c      if((dtime(i).gt.55090.0).and.(dtime(i).lt.55095.0)) goto 9
c      if((dtime(i).gt.55153.0).and.(dtime(i).lt.55154.0)) goto 9
c      if((dtime(i).gt.55180.0).and.(dtime(i).lt.55187.0)) goto 9
c      if((dtime(i).gt.55216.5).and.(dtime(i).lt.55220.0)) goto 9
c      if((dtime(i).gt.55250.0).and.(dtime(i).lt.55252.0)) goto 9
c      if((dtime(i).gt.55272.0).and.(dtime(i).lt.55281.0)) goto 9
c      if((dtime(i).gt.55334.0).and.(dtime(i).lt.55343.5)) goto 9
c      if((dtime(i).gt.55367.5).and.(dtime(i).lt.55372.0)) goto 9
c      if((dtime(i).gt.55031.8).and.(dtime(i).lt.55033.4)) goto 9
c      if((dtime(i).gt.55077.6).and.(dtime(i).lt.55079.4)) goto 9
